...
contract Wikipedia {
    ...
    mapping(address => Article[]) public articlesByAddress;
    ...
    function addNewArticle(
        ...
        // articlesByAddress[msg.sender] = articlesByAddress[msg.sender].push(articlesById[id]);
        return id;
    }
    ...
    function getArticleIpfsHash(uint256 id) public view returns (string memory) {
        return articlesById[id].ipfsHash;
    }

    function getArticleImageHash(uint256 id) public view returns (string memory) {
    ...
    function getLastArticles() public view returns (Article[] memory) {
